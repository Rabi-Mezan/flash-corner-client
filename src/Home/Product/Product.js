...
const Product = ({ product }) => {
    ...
    return (
        ...
        <div className='mt-8'>
            <div class="p-8" >
                <div class="lg:flex max-w-md bg-white shadow-lg rounded-lg overflow-hidden hover:scale-105 transition transform duration-500 " style={{ height: '220px' }}>
                    <div class="lg:w-1/3 p-2 bg-cover">
                        <img src={img} alt="" />
                    </div>
                    <div class="lg:w-2/3 p-4">
                        <h1 class="text-gray-900 font-bold text-xl">{name}</h1>
                        <p class="mt-2 text-gray-600 text-sm">{description.slice(0, 50)}..</p>
